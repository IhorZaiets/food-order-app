...
const Checkout = (props) => {
  ...
  const postalCodeControlClasses = `${classes.control} ${formInputsValidaty.postal? '' : classes.invalid}`
  ...
  return (
    <form className={classes.form} onSubmit={confirmHandler}>
      ...
      <div className={postalCodeControlClasses}>
        ...
        {!formInputsValidaty.postal && <p>Please enter a valid postal code (5 characters long)!</p>}
      </div>
